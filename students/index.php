...
<body background="img/k.jpg" class="body">
...
<div id="main">
   ...
   <div class="w3-teal" id="sec">
        <button id="openNav" class="w3-button w3-teal w3-xlarge" onclick="w3_open()">&#9776;</button>
      <div class="w3-container">
      	<table width="100%">
      		<tr><td>
           <font style="font-size: 30px;">Hii <?php if(isset($_SESSION['stid'])) echo $_SESSION['stid']; ?></font><font style="font-size: 20px;">&nbsp;&nbsp;&nbsp;&nbsp;Welcome To Your LIBRARY</font>
       </td>
       <td align="right">
       	<table>
...
<div class="dropdown" id="d1">
  ...
  <div class="dropdown-content" id="d3">
   ...
   <marquee style="font-size: 20px;" id="c1"><font style="color: red;">New Books Are available</font><a href="index2.php?s1page=1">&nbsp;&nbsp;Click Here To See it.</a></marquee>
       ...
       <div class="maincontent" id="c1">
       	  <ul class="nav nav-tabs nav-justified" style="box-shadow: 2px 5px 2px #3973ac">
            <li role="presentation"><a href="?spage=1" style="font-size: 20px;" id="na">Dashboard</a></li>
            <li role="presentation"><a href="?spage=2" style="font-size: 20px;" id="na">Issued Books</a></li>
          </ul>
       </div>
...
<a href="#sec" onclick="scrollFunction()" id="ln"><button id="mybtn" title="Go to top"><img src="img/m.png" width="50" height="50" class="img-responsive img-circle"></button></a>
